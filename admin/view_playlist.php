   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">actualizar curso</a>
            <input type="submit" value="borrar curso" class="delete-btn" onclick="return confirm('borrar este curso?');" name="delete">
         </form>
      </div>
   </div>
   <?php
