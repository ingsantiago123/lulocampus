...
<section class="contents">
   ...
   <h1 class="heading">administrador contenido</h1>
   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="borrar" class="delete-btn" onclick="return confirm('desea borrar este video?');" name="delete_video">
         </form>
